 ...
 */
public class OptionMenu03 extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        menu.add("GuGudanV01 for java");
        menu.add("Calculator01 for java");
        menu.add("ImageViewEx02 for java");
        menu.add("TarotV01 for java");
        menu.add("Lotto_version1 for java");
        return true;
    }
