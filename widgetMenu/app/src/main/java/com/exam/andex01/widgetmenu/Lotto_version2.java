 ...
 */
public class Lotto_version2 extends Activity implements View.OnClickListener {
    ...
    int[] topImg = {R.id.ball01, R.id.ball02, R.id.ball03, R.id.ball04, R.id.ball05, R.id.ball06,R.id.ball07};
    ImageView topImgs[] = new ImageView[topImg.length];

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lotto_version2);
