...
<body>
	...
	<div class="container">
		<h3>MemberShip <small>판매자 회원가입</small></h3>
		<hr>
		<form class="form" action="${pageContext.request.contextPath}/logincont/join_seller.do" method="post" name="joinform">
			<h4>기본 정보 입력</h4>
			...
			<h4>판매자 정보 입력</h4>
			<input type="text" name="company" placeholder="회사명"><br>
			<input type="text" name="licensee_no" placeholder="사업자번호(-없이 입력)"><br>
			<input type="text" name="account" placeholder="거래에 사용할 계좌 입력(-없이 입력)"><br>
			<input type="text" name="company_phone" placeholder="대표번호(-없이 입력)"><br>
